export const labels = {
  ko: {
    ...
    workflow: 'Workflow', workflowCreate: 'Workflow 생성', workflowTemplate: 'Workflow 템플릿', workflowPreview: '미리보기', workflowInstance: 'Instance ID', workflowStep: '현재 단계', workflowSteps: '단계',
  ...
  en: {
    ...
    workflow: 'Workflow', workflowCreate: 'Create workflow', workflowTemplate: 'Workflow template', workflowPreview: 'Preview', workflowInstance: 'Instance ID', workflowStep: 'Current step', workflowSteps: 'steps',
