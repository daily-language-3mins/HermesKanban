...
export const labels = {
  'zh-Hant': {
    ...
    moreActions: '更多', advancedActions: '進階功能', closeActions: '關閉進階功能', overview: '概覽', blockerLifecycle: '卡住與生命週期', workerRunsMonitor: 'Worker 執行與監控', commentsEvents: '留言與事件', reviewMetadata: 'PR／Review 資訊', claimHeartbeat: 'Claim／Heartbeat', blockedSignal: '卡住', liveSignal: '執行中', dependenciesSignal: '依賴', commentsSignal: '留言', reviewSignal: 'Review', prSignal: 'PR', operations: 'Operations', opsOverview: 'Operations 總覽', opsRunning: '執行中', opsHeartbeatOverdue: 'Heartbeat 逾時', opsRetryQueue: 'Retry queue', opsBlockedAfterRetries: '重試後卡住', opsRecentFailures: '近期失敗', opsNoRunning: '沒有執行中的任務', opsNoRetry: '沒有可重試項目', opsNoBlockedAfterRetries: '沒有重試後卡住的任務', opsNoFailures: '近期沒有失敗事件', opsEligibleNow: '現在可執行', opsEstimatedWait: '預估等待', opsAttempt: '嘗試次數', opsLastError: '最後錯誤', opsOpenTask: '開啟任務', opsEstimatedBackoffAdvisory: '顯示的 backoff 是依目前失敗資訊估算的參考值，dispatcher 尚未強制套用。', empty: '無'
  },
  ko: {
